...
type 'Aa option =
  | None 
  | Some of 'Aa 
let uu___is_None : 'Aa . 'Aa option -> Prims.bool =
  fun projectee  -> match projectee with | None  -> true | uu____32 -> false 
let uu___is_Some : 'Aa . 'Aa option -> Prims.bool =
  fun projectee  -> match projectee with | Some v -> true | uu____58 -> false 
let __proj__Some__item__v : 'Aa . 'Aa option -> 'Aa =
...
let __proj__Mktuple8__item___1 :
  ...
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8) -> _1 
let __proj__Mktuple8__item___2 :
  'a 'b 'c 'd 'e 'f 'g 'h . ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h) -> 'b =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8) -> _2 
let __proj__Mktuple8__item___3 :
  'a 'b 'c 'd 'e 'f 'g 'h . ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h) -> 'c =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8) -> _3 
let __proj__Mktuple8__item___4 :
  'a 'b 'c 'd 'e 'f 'g 'h . ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h) -> 'd =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8) -> _4 
let __proj__Mktuple8__item___5 :
  'a 'b 'c 'd 'e 'f 'g 'h . ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h) -> 'e =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8) -> _5 
let __proj__Mktuple8__item___6 :
  'a 'b 'c 'd 'e 'f 'g 'h . ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h) -> 'f =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8) -> _6 
let __proj__Mktuple8__item___7 :
  'a 'b 'c 'd 'e 'f 'g 'h . ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h) -> 'g =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8) -> _7 
let __proj__Mktuple8__item___8 :
  'a 'b 'c 'd 'e 'f 'g 'h . ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h) -> 'h =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8) -> _8 
...
let __proj__Mktuple9__item___1 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'a
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _1 
let __proj__Mktuple9__item___2 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'b
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _2 
let __proj__Mktuple9__item___3 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'c
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _3 
let __proj__Mktuple9__item___4 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'd
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _4 
let __proj__Mktuple9__item___5 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'e
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _5 
let __proj__Mktuple9__item___6 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'f
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _6 
let __proj__Mktuple9__item___7 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'g
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _7 
let __proj__Mktuple9__item___8 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'h
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _8 
let __proj__Mktuple9__item___9 :
  'a 'b 'c 'd 'e 'f 'g 'h 'i .
    ('a * 'b * 'c * 'd * 'e * 'f * 'g * 'h * 'i) -> 'i
  =
  fun projectee  -> match projectee with | (_1,_2,_3,_4,_5,_6,_7,_8,_9) -> _9 
...
let (uu___is_Simpl : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Simpl  -> true | uu____13171 -> false
  
let (uu___is_Weak : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Weak  -> true | uu____13183 -> false
  
let (uu___is_HNF : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | HNF  -> true | uu____13195 -> false
  
let (uu___is_Primops : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primops  -> true | uu____13207 -> false
  
let (uu___is_Delta : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Delta  -> true | uu____13219 -> false
  
let (uu___is_Zeta : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Zeta  -> true | uu____13231 -> false
  
let (uu___is_Iota : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Iota  -> true | uu____13243 -> false
  
let (uu___is_NBE : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | NBE  -> true | uu____13255 -> false
  
let (uu___is_Reify : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reify  -> true | uu____13267 -> false
  
let (uu___is_UnfoldOnly : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldOnly _0 -> true | uu____13284 -> false
  
let (__proj__UnfoldOnly__item___0 : norm_step -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | UnfoldOnly _0 -> _0 
let (uu___is_UnfoldFully : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldFully _0 -> true | uu____13318 -> false
  
let (__proj__UnfoldFully__item___0 : norm_step -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | UnfoldFully _0 -> _0 
let (uu___is_UnfoldAttr : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldAttr _0 -> true | uu____13352 -> false
